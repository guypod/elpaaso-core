...
public class CfAdapterImplIT {
	...
	public void registersUriAndTheirParentDomain() {
		...
		Route route = new Route(new RouteUri("webGui.CfConsummerIT.gberche-dev-box.guillaume-berche.cfapps.elpaaso.net"), "", space, td);
	...
	public void deleting_application_also_deletes_routes_domains_and_ignores_deletion_failures() {
		...
		Route route1 = new Route(new RouteUri("host1.mysubdomain.cfapps.elpaaso.net"), "root1", space, td);
		Route route2 = new Route(new RouteUri("host2.mysubdomain.cfapps.elpaaso.net"), "root2", space, td);
		app.mapRoute(route1);
		app.mapRoute(route2);
	...
	public void deleting_application_should_not_delete_paas_domain_shared_by_all_apps() {
		...
		Space space = new Space(td);
		App app = new App(td, space, "appName", mock(MavenReference.class), "java", 512, 1);
		Route route1 = new Route(new RouteUri("myenv-jeeprobewe-myjeeprobetestc-uat.cfapps.elpaaso.net"), "root1", space, td);
		app.mapRoute(route1);
